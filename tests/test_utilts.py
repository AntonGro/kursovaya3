from src.utilts import *


def test_get_executed_operations():
    assert operations_get_executed([{"state": "EXECUTED"}]) == [{"state": "EXECUTED"}]
    assert operations_get_executed([{}]) == []


def test_sort_date_operations():
    assert operations_sort_date([{"date": "2018-03-23T10:45:06.972075"},
...
def test_change_date():
    assert date_change([{"date": "2018-03-23T10:45:06.972075"}]) == ['23.03.2018']
